...
ggplot(data=log_frame_output, aes(x=logFC, y=-log10(P.Value),col=Expression,label=label)) +
  ...
  labs(y= "-log10(p value)",x="Fold change",title ="Volcano plot for β-catenin shRNA KG1 with top 20 upregulated and downregulated proteins highlighted") +
...
tiff("~/heatmap_KG1_shRNA.tiff",width=1200,height= 800,units = "px")
heatmap.2(heatmap_matrix,main="KG1 sRNA sample heatmap with dendrogram",cexRow = 1,density.info="none",
