...
TMT= readxl::read_xlsx(
  "~/Documents/Rhys_Proteomics/Data/Rhys Morgan 170921 6Plex_Set 2 RM edit.xlsx")
...
ggplot(data=log_frame_output, aes(x=logFC, y=-log10(P.Value),col=Expression,label=label)) +
  ...
  labs(y= "-log10(p value)",x="Fold change",title ="Volcano plot for CHIR treated NB4 with top 20 upregulated and downregulated proteins highlighted") +
...
tiff("~/heatmap_NB4_chir.tiff",width=1200,height= 800,units = "px")
heatmap.2(heatmap_matrix,main="NB4 Sample heatmap with dendrogram",cexRow = 1,density.info="none",
